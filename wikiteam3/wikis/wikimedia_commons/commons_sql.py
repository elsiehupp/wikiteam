...
def main():
    ...
    with open(filename, "w") as commons_csv_file:
        commons_csv_file.write(
    ...
    with open(filename, "a") as commons_csv_file:
        f = csv.writer(
            commons_csv_file, delimiter="|", quotechar='"', quoting=csv.QUOTE_MINIMAL
        )
