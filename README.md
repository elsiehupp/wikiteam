...
### 3. Uninstalling the package and deleting the cloned repository
...
If the script can't itself find the api.php and/or index.php paths, then you can provide them:
...
**WikiTeam** is the [Archive Team](http://www.archiveteam.org) GitHub subcommittee on wikis.
